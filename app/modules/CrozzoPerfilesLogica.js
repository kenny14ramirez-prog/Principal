...
(function (global) {
  ...
  var OPERATIVE_PROFILES = {
    ...
    /** Hotel front desk — cobra y une cuentas; no anula comandado ni marca LISTO. KI-031 */
    recepcion: {
      id: 'recepcion',
      label: 'Recepción / Front desk',
      tagline: 'Habitación/mesa: cobra, une/divide y precuenta — no borra lo ya enviado a cocina.',
      sequence: [
        'Abrir habitación/mesa o pedido en caja',
        'Cobrar / facturar y precuenta',
        'Unir o dividir cuentas',
        'Cierre de turno si aplica',
      ],
      cannot: [
        'Anular ítems ya comandados',
        'Marcar LISTO en cocina',
        'Configurar el negocio',
      ],
      actions: {
        cobrar: { allow: true, perm: 'facturar' },
        unir_dividir: { allow: true, perm: ['unir_cuenta', 'dividir_cuenta'] },
        editar_pre_comandar: { allow: true, perm: ['editar_orden'] },
        modificar_post_comandar: { allow: false },
        eliminar_cuenta: { allow: false },
        eliminar_mesa: { allow: false },
        comandar: { allow: true, perm: ['abrir_orden', 'editar_orden'] },
