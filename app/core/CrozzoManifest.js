...
(function (global) {
  ...
  var PAGE_SCRIPTS = {
    ...
    'compras-proveedores': [BUNDLES.compras, BUNDLES.reservorio],
    'compras-recepcion': ['vendor/CrozzoPdfJs.js', BUNDLES.compras, BUNDLES.costos, BUNDLES.reservorio],
    ...
    'sistema-costos': [BUNDLES.costos, BUNDLES.reservorio, M + 'CrozzoPedidosInternosEngine.js'],
    'costos-matriz': [BUNDLES.costos, BUNDLES.reservorio, M + 'CrozzoPedidosInternosEngine.js'],
