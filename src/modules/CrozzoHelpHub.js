...
(function (global) {
  ...
  var ARTICLES = [
    ...
    },
    {
      ...
      pages: ['costos-matriz', 'comandas', 'tablets'],
      steps: ['Costos → Costos y márgenes → edite el plato', 'Marque alérgenos aplicables', 'En pedido agregue observación si el cliente lo pide'],
      action: { type: 'navigate', page: 'costos-matriz' },
      actionLabel: 'Ir a costos y márgenes',
    },
    {
