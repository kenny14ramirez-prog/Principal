...
mustContain('app/infra/CrozzoOfflineGossip.js', 'shouldBlockOutboundPublish', 'gossip debe bloquear publicación en standby');
mustContain('app/infra/CrozzoOfflineGossip.js', 'ensureStandby', 'gossip standby');
mustContain('app/infra/CrozzoDeviceMind.js', 'ensureMeshStandby', 'DeviceMind mesh standby');
mustContain('app/index.html', 'CrozzoDeviceMind.js', 'index sin DeviceMind');
